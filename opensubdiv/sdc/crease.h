...
public:
    ...
    // declared as constexpr to work around CMake's WINDOWS_EXPORT_ALL_SYMBOLS limitations
    static constexpr float const SHARPNESS_SMOOTH = 0.0f;   
    static constexpr float const SHARPNESS_INFINITE = 10.f;
